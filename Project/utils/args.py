...
def get_parser():
    ...
    parser.add_argument('--d', type=int, default=10, help='pow_d')
    ...
    parser.add_argument('--gc', type=int, default=1100, help='after how many rounds call the garbage collector for cleaning GPU')
